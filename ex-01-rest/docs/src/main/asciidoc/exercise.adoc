...
Exercise 01 - REST
:generator-api-dir: ../../../../services/generator-api
...
[source,java]
----
include::{generator-api-dir}/src/main/java/org/bookstore/generator/rest/NumberGeneratorResource.java[tags=adocSnippet]
----
...
[source,yml]
----
include::{generator-api-dir}/src/main/resources/application.yml[]
----
...
[source,java]
----
include::{generator-api-dir}/src/test/java/org/bookstore/generator/rest/NumberGeneratorResourceIntTest.java[tags=adocSnippet]
----
