...
public class AuthorResourceIntTest {
    ...
    private static final Language UPDATED_PREFERRED_LANGUAGE = Language.FRENCH;
    ...
    public void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getPreferredLanguage()).isEqualTo(DEFAULT_PREFERRED_LANGUAGE);
    }
    ...
    public void updateAuthor() throws Exception {
        ...
        assertThat(testAuthor.getPreferredLanguage()).isEqualTo(UPDATED_PREFERRED_LANGUAGE);
    }
    ...
    public void checkHealth() throws Exception {
        // Checks health
        restAuthorMockMvc.perform(get("/api/authors/health"))
                .andExpect(status().isOk());
    }
}
